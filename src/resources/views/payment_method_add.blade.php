...
<div class="payment-method">
    ...
    <form class="payment-method__form" action="{{ route('payment_method.add.submit', ['item_id' => $item_id]) }}" method="POST">
        ...
        <div class="payment-method__row">
            ...
            <input class="payment-method__input" type="text" name="card_number" id="card_number" value="">
        </div>
        <div class="payment-method__row">
            <label class="payment-method__label" for="cardholder_name">名義人</label>
            <input class="payment-method__input" type="text" name="cardholder_name" id="cardholder_name" value="">
        </div>
        <div class="payment-method__row">
            <label class="payment-method__label" for="expiration_date">有効期限</label>
            <input class="payment-method__input" type="text" name="expiration_date" id="expiration_date" value="">
        </div>
        <div class="payment-method__row">
